...
- 生成: 2026-09-11 02:40 JST
- コミット: `a298f7a` (main) / 2026-09-11 02:13
...
| ファイル | 行数 | sha1 | 更新 | 概要 |
| --- | ---: | --- | --- | --- |
| update_financials.py | 905 | `1849b415` | 2026-09-11 02:15 |  |
| financials.py | 155 | `7d573865` | 2026-09-11 02:15 | financial_cache.csv の読み込み・正規化・妥当性チェック。 |
| run_screener.py | 465 | `abcace1c` | 2026-09-11 02:15 |  |
| run_screener_local.py | 300 | `424a664f` | 2026-09-11 02:15 | 地方単独上場（現状は名証）のネットネット候補を抽出し、 |
| price_metrics.py | 180 | `5f50fa80` | 2026-09-11 02:15 | ネットネットスクリーナー用の価格指標を計算して列として追加するモジュール。 |
| save_history.py | 197 | `386a7ea7` | 2026-09-11 02:15 |  |
| jpx_alerts.py | 138 | `c1e4138c` | 2026-09-11 02:15 | JPX が公開している監理・整理銘柄一覧を取得し、DataFrame で返す。 |
| fetch_jpx_listed.py | 244 | `227df474` | 2026-09-11 02:15 | JPXが公開している「東証上場銘柄一覧」を取得し、証券コードの一覧を作る。 |
| fetch_local_prices.py | 478 | `37172d10` | 2026-09-11 02:15 | 名証（名古屋証券取引所）の株式相場表PDFから株価・売買高を抽出する。 |
| generate_html.py | 133 | `4b7dee36` | 2026-09-11 02:15 | 社名を取り出す。 |
| generate_local_html.py | 249 | `61df2e74` | 2026-09-11 02:15 | 地方市場（名証）版ネットネット候補ページの生成。 |
| generate_shortlist.py | 522 | `585b5419` | 2026-09-11 02:15 | net_net_candidates.csv（run_screener.py が出力、price_metrics.py で価格指標付与済み） |
| make_context.py | 286 | `2898f857` | 2026-09-11 02:15 | リポジトリの現状を CONTEXT.md 一枚にまとめる。 |

## データファイル

### financial_cache.csv

- 行数: 3,831 / 列数: 29 / 更新: 2026-09-11 02:15
...
- 行数: 3,035 / 列数: 8 / 更新: 2026-09-11 02:40
...
- 行数: 142 / 列数: 29 / 更新: 2026-09-11 02:40
...
sec_code    company_name ticker price   market_cap        ncav           nc_ratio equity_ratio cash_and_equivalents      net_cash      net_cash_ratio current_assets total_liabilities total_assets accounting_standard consolidated fiscal_period    bs_date submit_date 調整後終値 前日比% 5日騰落% 20日騰落% 60日安値乖離% 120日安値乖離% 52週安値乖離% 52週高値乖離% 停滞日数 20日平均売買代金(百万円)
    7034 株式会社プロレド・パートナーズ 7034.T 340.0 3716741960.0 10348348000 2.7842524747130954        85.15         5667289000.0  3609190000.0  0.9710628391323675    12406447000        2058099000  13861295000              J-GAAP           個別    2026-10-31 2026-04-30  2026-06-15 340.0 -0.3  -1.7  -11.5      3.7       3.7      3.7    -57.4    6           10.0
    8783         ａｂｃ株式会社 8783.T  52.0 2376619336.0  5079114000 2.1371171744097937        66.42          767437000.0 -4121891000.0 -1.7343505278962352     9968442000        4889328000  14561749000              J-GAAP           個別    2026-08-31 2026-02-28  2026-04-14  52.0 -1.9  -7.1  -35.8      4.0       4.0      4.0    -88.2    3           61.9
```

### net_net_candidates_local.csv

- 行数: 4 / 列数: 38 / 更新: 2026-09-11 02:40
...
- 行数: 3,207 / 列数: 14 / 更新: 2026-09-11 02:40
...
- 行数: 1 / 列数: 12 / 更新: 2026-09-11 02:15
...
- 行数: 1 / 列数: 12 / 更新: 2026-09-11 02:40
- 列: `sec_code`, `filer_name`, `company_name`, `current_assets`, `total_liabilities`, `total_assets`, `equity_value`, `equity_ratio`, `doc_id`, `fiscal_period`, `bs_date`, `submit_date`
...
- 行数: 3,938 / 列数: 1 / 更新: 2026-09-11 02:15
- 列: `doc_id`
...
- 行数: 122 / 列数: 4 / 更新: 2026-09-11 02:40
- 列: `コード`, `銘柄名`, `指定年月日`, `区分`
...
- 行数: 4,434 / 列数: 4 / 更新: 2026-09-11 02:15
...
- 行数: 5,072 / 列数: 12 / 更新: 2026-09-11 02:40
...
- 行数: 317 / 列数: 15 / 更新: 2026-09-11 02:40
...
- index.html: 57 KB / 更新 2026-09-11 02:40
- shortlist.html: 98 KB / 更新 2026-09-11 02:40
- local.html: 8 KB / 更新 2026-09-11 02:40
